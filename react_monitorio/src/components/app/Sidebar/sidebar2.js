  ...
  <div className="layout-w">
    <div className="menu-mobile menu-activated-on-click color-scheme-dark">
      <div className="mm-logo-buttons-w">
        <a className="mm-logo" href="index.html"><img src="assets/img/logo.png" /><span>Clean Admin</span></a>
        ...
        <ul className="main-menu">
          ...
          <li className="has-sub-menu">
            ...
            <ul className="sub-menu">
              ...
              <li>
                <a href="ecommerce_order_info.html">Order Info <strong className="badge badge-danger">New</strong></a>
              </li>
              <li>
                <a href="rentals_index_grid.html">Property Listing <strong className="badge badge-danger">New</strong></a>
              </li>
    ...
    <div className="menu-w color-scheme-dark color-style-bright menu-position-side menu-side-left menu-layout-compact sub-menu-style-over sub-menu-color-bright selected-menu-color-light menu-activated-on-hover menu-has-selected-link">
