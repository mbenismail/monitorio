 ...
 */
final class Version20220221151933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profil CHANGE profil_desc profil_desc VARCHAR(255) DEFAULT NULL, CHANGE date_creat date_creat DATETIME NOT NULL, CHANGE user_creat user_creat VARCHAR(255) DEFAULT NULL, CHANGE date_modif date_modif DATETIME NOT NULL, CHANGE user_modif user_modif VARCHAR(255) DEFAULT NULL');
