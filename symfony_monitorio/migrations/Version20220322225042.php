 ...
 */
final class Version20220322225042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE permission DROP profiles_id, CHANGE desc_perm desc_perm VARCHAR(255) DEFAULT NULL, CHANGE date_creat date_creat DATE DEFAULT NULL, CHANGE user_creat user_creat VARCHAR(255) DEFAULT NULL, CHANGE date_modif date_modif DATE DEFAULT NULL, CHANGE user_modif user_modif VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE profil DROP FOREIGN KEY FK_E6D6B2979C3E4F87');
        $this->addSql('DROP INDEX IDX_E6D6B2979C3E4F87 ON profil');
        $this->addSql('ALTER TABLE profil DROP permissions_id, CHANGE user_creat user_creat VARCHAR(255) DEFAULT NULL, CHANGE user_modif user_modif VARCHAR(255) DEFAULT NULL, CHANGE profil_desc profil_desc VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profil ADD permissions_id INT DEFAULT NULL, CHANGE nom_profil nom_profil VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE profil_desc profil_desc VARCHAR(255) DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE user_creat user_creat VARCHAR(255) DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE user_modif user_modif VARCHAR(255) DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE profil ADD CONSTRAINT FK_E6D6B2979C3E4F87 FOREIGN KEY (permissions_id) REFERENCES permission (id)');
        $this->addSql('CREATE INDEX IDX_E6D6B2979C3E4F87 ON profil (permissions_id)');
